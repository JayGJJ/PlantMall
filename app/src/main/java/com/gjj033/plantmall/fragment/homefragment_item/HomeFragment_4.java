...
public class HomeFragment_4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_home_4, container, false);//将布局文件转换为视图返回
        return rootView;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = rootView.findViewById(R.id.recycler_view4);
        //初始化数据列表
        plantList = new PlantsListData(getContext()).getPlantsList(3);
        //设置瀑布流布局管理器
